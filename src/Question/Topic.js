  ...
  return (
    <div>
      ...
      <div>
        ...
        <button type="button" className="btn btn-primary" style={{ position: "absolute", right: 0 }}>+  Add Topic</button>
      </div>
      ...
      <div className='navbar border-bottom' style={{ margin: "80px", marginBottom: "10px", marginTop: "0" }}>
        ...
        <input type="text" placeholder='serach Topic' class=" end" onChange={(e) => setterm(e.target.value)} />
      </div>

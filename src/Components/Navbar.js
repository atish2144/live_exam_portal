...
<nav className="navbar navbar-expand-lg navbar-light bg-dark" >
  ...
  <div className="collapse navbar-collapse" id="navbarTogglerDemo02">
    <ul className="navbar-nav mr-auto mt-2 mt-lg-0 py-auto" >
      ...
      <label><li onClick={()=>navigate("/Login")} className="nav-item mt-3   ml-2" style={{color:"white",marginRight:"20px"}}>
        Dashboard
      </li></label> 
      
      <li onClick={()=>navigate('/Login/Questions')} className="nav-item mt-3   ml-2" style={{color:"white",marginRight:"20px"}}>
          Question
      </li> 
